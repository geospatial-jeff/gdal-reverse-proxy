...
var group = groupcache.NewGroup("requests", 3<<20, groupcache.GetterFunc(
	func(_ context.Context, key string, sink groupcache.Sink) error {
		...
		rawURL := "http://sentinel-cogs.s3.amazonaws.com"
		...
		originalRequest.Host = "sentinel-cogs.s3.amazonaws.com"
